...
#ifndef LIBGDSUP_SUPPORT_SUPPORT_H_INCLUDED
#define LIBGDSUP_SUPPORT_SUPPORT_H_INCLUDED
...
__EXTERN_C_BEGIN
extern int __support_logging_enabled;  // NOLINT
__EXTERN_C_END

#endif  // LIBGDSUP_SUPPORT_SUPPORT_H_INCLUDED
